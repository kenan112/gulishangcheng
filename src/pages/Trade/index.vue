  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(detail, index) in orderInfo.detailArrayList"
          :key="index"
        >
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ isSelected.fullAddress }}</span>
        收货人：<span>{{ isSelected.consignee }}</span>
        <span>{{ isSelected.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapState({
      addressInfo: (state) => state.trade.adress,
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        consignee: this.isSelected.consignee,
        consigneeTel: this.isSelected.phoneNum,
        deliveryAddress: this.isSelected.fullAddress,
        paymentWay: "ONLINE",
