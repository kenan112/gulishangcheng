        ...
        <ul class="cart-list" v-for="good in cartInfoList" :key="good.id">
          <li class="cart-list-con1">
            <input
              ...
              @change="updateChecked(good.skuId, $event)"
            />
          </li>
          ...
          <li class="cart-list-con5">
            <a @click="handler('mins', -1, good)" class="mins">-</a>
            <input
              autocomplete="off"
              type="text"
              :value="good.skuNum"
            ...
            />
            <a @click="handler('add', 1, good)" class="plus">+</a>
          </li>
...
export default {
  ...
  methods: {
    ...
    handler: debounce(async function (type, disNum, good) {
      switch (type) {
        case "add":
          disNum = 1;
          break;
        ...
        case "change":
          ...
          // }
          disNum =
            isNaN(disNum * 1) || disNum < 1
              ? 0
              : parseInt(disNum) - good.skuNum;
          break;
      }
      try {
