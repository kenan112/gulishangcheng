        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li
              ...
              :key="index"
            >
              {{ p.split(":")[1] }}<i @click="removeProp(index)">×</i>
            </li>
          </ul>
        </div>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changOrder(1)">
                  <a
                    >综合<span v-show="isOne">{{ isDesc ? "⬇" : "⬆" }}</span></a
                  >
                </li>
                <li :class="{ active: isTwo }" @click="changOrder(2)">
                  <a
                    >价格<span v-show="isTwo">{{ isDesc ? "⬇" : "⬆" }}</span></a
                  >
                </li>
              </ul>
            </div>
...
export default {
  ...
  computed: {
    ...
    isOne() {
      if (this.searchParams.order.indexOf("1") !== -1) return true;
    },
    isTwo() {
      if (this.searchParams.order.indexOf("2") !== -1) return true;
    },
    isDesc() {
